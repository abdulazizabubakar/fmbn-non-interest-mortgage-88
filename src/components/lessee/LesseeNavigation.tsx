...
import { 
  Home, FileText, Calendar, MessageSquare, ShieldCheck,
  Receipt, CreditCard, Settings, LogOut, ChevronRight
} from 'lucide-react';
...
const LesseeNavigation: React.FC = () => {
...
export default LesseeNavigation;
